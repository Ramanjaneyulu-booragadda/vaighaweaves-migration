...
class StatusPagesApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    ...
    listDegradations(filterPageId, pageOffset, pageLimit, include, filterStatus, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            const _config = _options || this.configuration;
            // Path Params
...
class StatusPagesApi {
    ...
    listDegradations(param = {}, options) {
        const requestContextPromise = this.requestFactory.listDegradations(param.filterPageId, param.pageOffset, param.pageLimit, param.include, param.filterStatus, options);
        return requestContextPromise.then((requestContext) => {
            return this.configuration.httpApi
                .send(requestContext)
                .then((responseContext) => {
